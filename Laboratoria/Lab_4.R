...
auta2012 %>% 
  ...
  summarise(x = mean(Cena.w.PLN)) %>% 
  ggplot(aes(x = Rok.produkcji, y = x)) +
  geom_point()

auta2012 %>% 
  filter(Marka == "Volkswagen", Rok.produkcji > 2000) %>% 
  ggplot(aes(x = Cena.w.PLN, y = factor(Rok.produkcji))) +
  geom_boxplot()
...
auta2012 %>% 
  ...
  ggplot(aes(x = Rok.produkcji, y = cena)) +
  geom_col()

auta2012 %>% 
  filter(Marka == "Volkswagen", Rok.produkcji > 2000) %>% 
  ggplot(aes(x = Cena, y = factor(Rok.produkcji))) +
  geom_violin()
