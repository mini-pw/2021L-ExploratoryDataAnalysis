...
# 0) Prowadzący.
## Pierwsza część semestru - praca z R - Anna Kozak
## Druga część semestru - praca z Python - Krzysztof Spaliński
## Kontakt: MS Teams

# 1) Materiały do zajęć.
## Repozytorium na GitHub
## https://github.com/mini-pw/2021L-ExploratoryDataAnalysis
